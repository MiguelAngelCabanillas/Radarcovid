...
function setLanguageIt(){ 
    ...
    $lang['alert_select_row'] = "� necessario selezionare una o pi� righe di effettuare questa operazione!";    
    ...
    $lang['cloning_record_blocked'] = "Controllo di sicurezza: tentativo di clonare un record! Controllare le impostazioni, l'operazione non � permesso!";
    ...
    $lang['export_to_word'] = "Esporta su Word";
    $lang['export_to_xml'] = "Esporta su XML";
    $lang['export_message'] = "<label class=\"default_class_label\">Il file _FILE_ � pronto. Dopo avere finito il download,</label> <a class=\"default_class_error_message\" href=\"javascript: window.close();\">Chiudi la finestra</a>.";
    $lang['field'] = "Campo"; 
    ...
    $lang['required_fields_msg'] = "<span style='color:#cd0000'>*</span>Gli oggetti marcati con asterisco sono obbligatori";
    $lang['search'] = "Cerca"; 
