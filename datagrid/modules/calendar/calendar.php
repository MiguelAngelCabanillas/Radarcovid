...
function initCalendar() {
    ...
    if(!year && !month && !day) {
        ...
        if(window.opener.dateField && window.opener.dateField.value){
            ...
            if(window.opener.dateType == 'datetimedmy' || window.opener.dateType == 'datetimemdy' || window.opener.dateType == 'datetime'
                || window.opener.dateType == 'date'     || window.opener.dateType == 'datedmy'
                || window.opener.dateType == 'datemdy'){

                if(window.opener.dateType == 'datetime' || window.opener.dateType == 'datetimedmy' || window.opener.dateType == 'datetimemdy'){
                    parts   = value.split(' ');
                    value   = parts[0];
                    if (parts[1]) {
                        time    = parts[1].split(':');
                ...
                if(window.opener.dateType == 'datedmy' || window.opener.dateType == 'datetimedmy'){
                    date        = value.split("<?php echo $separator; ?>");
                    day         = parseInt(date[0],10);
                    month       = parseInt(date[1],10) - 1;
                    year        = parseInt(date[2],10);
                }else if(window.opener.dateType == 'datemdy' || window.opener.dateType == 'datetimemdy'){
                    date        = value.split("<?php echo $separator; ?>");
    ...
    for (i = 1; i <= lastDay; i++) {
        ...
        if(window.opener.dateType == 'datetimemdy' || window.opener.dateType == 'datetimedmy' || window.opener.dateType == 'datetime' || window.opener.dateType == 'date' || window.opener.dateType == 'datedmy' || window.opener.dateType == 'datemdy'){
            if (window.opener.dateType == 'datedmy' || window.opener.dateType == 'datetimedmy'){
                actVal = "" + formatNum2(i, 'day') + "<?php echo $separator; ?>" + formatNum2(dispmonth, 'month') + "<?php echo $separator; ?>" + formatNum4(year);
            }else if(window.opener.dateType == 'datemdy' || window.opener.dateType == 'datetimemdy'){
                actVal = "" + formatNum2(dispmonth, 'month') + "<?php echo $separator; ?>" + formatNum2(i, 'day') + "<?php echo $separator; ?>" + formatNum4(year);
            }else{
                actVal = "" + formatNum4(year) + "<?php echo $separator; ?>" + formatNum2(dispmonth, 'month') + "<?php echo $separator; ?>" + formatNum2(i, 'day');
            }        
        }else{
            if(window.opener.dateType == 'datedmy' || window.opener.dateType == 'datetimedmy'){
